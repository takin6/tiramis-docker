# -*- encoding: utf-8 -*-
# stub: docker-sync 0.5.11 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<thor>.freeze, ["~> 0.20", ">= 0.20.0"])
      s.add_runtime_dependency(%q<gem_update_checker>.freeze, ["~> 0.2.0", ">= 0.2.0"])
      s.add_runtime_dependency(%q<docker-compose>.freeze, ["~> 1.1", ">= 1.1.7"])
      s.add_runtime_dependency(%q<terminal-notifier>.freeze, ["= 2.0.0"])
      s.add_runtime_dependency(%q<dotenv>.freeze, ["~> 2.1", ">= 2.1.1"])
      s.add_runtime_dependency(%q<daemons>.freeze, ["~> 1.2", ">= 1.2.3"])
      s.add_runtime_dependency(%q<os>.freeze, [">= 0"])
      s.add_development_dependency(%q<pry>.freeze, [">= 0"])
    else
      s.add_dependency(%q<thor>.freeze, ["~> 0.20", ">= 0.20.0"])
      s.add_dependency(%q<gem_update_checker>.freeze, ["~> 0.2.0", ">= 0.2.0"])
      s.add_dependency(%q<docker-compose>.freeze, ["~> 1.1", ">= 1.1.7"])
      s.add_dependency(%q<terminal-notifier>.freeze, ["= 2.0.0"])
      s.add_dependency(%q<dotenv>.freeze, ["~> 2.1", ">= 2.1.1"])
      s.add_dependency(%q<daemons>.freeze, ["~> 1.2", ">= 1.2.3"])
